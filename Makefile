...
BDIR?=sam9x60ek sama5d29_curiosity sama5d27_som1_ek sama5d27_wlsom1_ek sama5d27_wlsom1_asher sama5d2_icp sama5d2_ptc_ek sama5d2_xplained sama5d2_xplained_grts sama5d3_xplained sama5d3_eds sama5d4_xplained sama7g5ek sam9x60_curiosity sam9x75eb mpfs_icicle mpfs_icicle_amp mpfs_video
...
SAMA5D27_WLSOM1_ASHER_DTBO_OBJECTS:= $(patsubst %.dtso,%.dtbo,$(wildcard sama5d27_wlsom1_asher/*.dtso))
...
sama5d27_wlsom1_asher_dtbos: $(SAMA5D27_WLSOM1_ASHER_DTBO_OBJECTS)
